...
import { deleteproductDispatch, showproductDispatch } from 'reducers/HomeReducer';
import { useState } from 'react';
import axios from 'axios';
import Swal from "sweetalert2"

const rows=[
	{id:"1",name:"snow",product_type:"demo",description:"demo",price:"123",offer_price:"1233",features_image:"123123",category_id:"123"},
...
export default function ProductTable() {
	...
	const fatchData=()=>{
		...
		const config = {
			...
			fetch(`https://loofer.bellazza.in/api/admin/product_details/2`,config).then(response => response.json())
				.then(res => {
